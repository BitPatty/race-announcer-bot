...
namespace RaceAnnouncer.Bot.Data.Controllers
{
  public static class TrackerController
  {
    ...
    {
      Tracker? t = context.GetTracker(tracker.Game.Abbreviation, tracker.Channel.Snowflake);
    ...
    public static Tracker? GetTracker(this DatabaseContext context, long id)
      => context
          .Trackers
          .Local
    ...
    public static Tracker? GetTracker(this DatabaseContext context, string gameAbbreviation, ulong channelSnowflake)
      => context
          .Trackers
          .Local
          .FirstOrDefault(t
            => t.Channel.Snowflake.Equals(channelSnowflake)
            && t.Game.Abbreviation.Equals(gameAbbreviation));
